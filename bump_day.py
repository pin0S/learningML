...
# How to use this:
# 
# create a file called day.dat and insert the number of the current day on it. 
# example: https://github.com/fernand0aguilar/100_Days_of_ML_Code/blob/master/.day.dat
# 
# Make this an executable file with -> "chmod +x bump_day.py" 
# ./bump_day.py 
# to create a new day and append in the log.md file
